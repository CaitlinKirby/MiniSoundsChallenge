...
- (NSError *)errorForResult:(NSString *)result
{
    ...
    if ([descriptionsDict objectForKey:result] != nil) {
        return [NSError errorWithDomain:BBCMediaSelectorErrorDomain code:[[descriptionsDict objectForKey:result][indexForErrorCode] intValue] userInfo:@{NSLocalizedDescriptionKey:[descriptionsDict objectForKey:result][indexForErrorDescription]}];
    } else {
        return [NSError errorWithDomain:BBCMediaSelectorErrorDomain code:BBCMediaSelectorErrorBadResponse userInfo:@{NSLocalizedDescriptionKey:BBCMediaSelectorErrorBadResponseDescription}];
    }
}
