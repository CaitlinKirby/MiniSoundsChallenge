...
struct TestHelper {
    ...
    struct Services {
        class StubPlaybackService: PlaybackService {
            ...
            init(
                playbackRepository: Repositories.StubPlaybackRepository = Repositories.StubPlaybackRepository()
            ) {
                self.playbackRepository = playbackRepository
                super.init(playbackRepository: playbackRepository)
                
            }
            
            var calledPlayOrPause = false
            override func playOrPause(_ id: String) {
                calledPlayOrPause = true
            }
        }
    ...
    struct Repositories {
        class StubPlaybackRepository: PlaybackRepository {
            var currrentlyLoadedID: String?
            
            var calledPlay = false
            func play(_ id: String) {
                currrentlyLoadedID = id
                calledPlay = true
            }
